...
- In every Experiment IR prose field, describe precision, recall, prevalence, and threshold comparisons in words. Never define a metric mathematically or use equals signs, arrows, function-call notation, URLs, raw paths, or command/SQL syntax.
