# Strict Devpost scorecard

Official rules checkpoint: `2026-07-18T19:39:42Z`
...
- Evidence supporting the shadow score: the learner and repeated failure are specific; misleading notebook scores are costly; immutable prediction, interpretation, surface-different transfer, and gated repair form a plausible learning mechanism; limitations are honest.
- Evidence preventing a higher score: `NO_DATA`, zero participants/completions, no observed time, confusion, abandonment, unassisted transfer, reaction, retention, or comparison arm; privacy/retention expectations need clearer presentation.
- Confidence interval: official `0–0`; shadow `4–10`.
- Most likely judge objection: “What did a learner do differently after CounterLab, rather than what do the software tests prove?”
- Largest score action: complete a small consented paired/counterbalanced explanation-only versus CounterLab study and report every denominator and first unassisted transfer attempt; if infeasible, run three usability sessions and make no learning-effect claim.

### Quality of the Idea — 0/25 official; 18/25 shadow

- Evidence supporting the shadow score: “scientific debugger for beliefs” is memorable; the synthesis of immutable prediction, discriminating plan, non-authoritative generation, fixed evidence, epistemic verdict, Boundary, transfer-gated copied repair, and portable proof is distinctive.
- Evidence preventing a higher score: individual mechanisms have strong comparables; only two adjacent ML packs demonstrate the category; the prepared submission copy uses weaker legacy framing; the sample omits a real Boundary.
- Confidence interval: official `0–0`; shadow `16–21`.
...
- Supporting evidence: exact source/image-bound public completion plus the already-substantive authority architecture and test suites.
- Preventing a higher score: full filesystem isolation may still be partial; not every failure/degraded mode will have large-scale production evidence; only two scientific packs may remain.
...
### Potential Impact — 16/25

- Supporting evidence: small real study with completion/time/confusion/first-transfer data and a defined learner population.
- Preventing a higher score: small sample, likely no delayed retention, narrow ML scope, and no classroom deployment.
- Confidence interval: `13–19`.
- Likely objection: “Promising immediate behavior, but too little evidence for durable learning or scale.”
- Largest score action: publish the smallest honest paired result with raw denominators and limitations.

### Quality of the Idea — 22/25

- Supporting evidence: one coherent category, exact six-step product loop, differentiated authority architecture, and no stale submission language.
- Preventing a higher score: category generality is still inferred if only two ML packs ship; comparable inquiry and notebook tools cover individual pieces.
- Confidence interval: `20–24`.
...
## State 3 — realistic prize-one ceiling
...
- Largest score action: make the exact public Capsule the index to every relevant source, verifier, engine, and release receipt.

### Design — 23/25

- Supporting evidence: crisp first 20 seconds, coherent learner loop, active Boundary/interpretation, honest modes, accessible responsive UI, strong recovery, and a sub-three-minute video that reaches the strongest moment quickly.
- Preventing a higher score: evidence-rich scientific UI remains denser than a conventional tutor and has limited real-user iteration.
- Confidence interval: `21–24`.
- Likely objection: “Still cognitively demanding for novices.”
- Largest score action: make the experiment intervention, controls, prediction, result, and why-it-matters visible together with technical drawers collapsed.

### Potential Impact — 20/25

- Supporting evidence: paired immediate-transfer behavior, completion/time/confusion data, qualitative reactions, privacy expectations, defined limitations, and plausible next study/deployment path.
- Preventing a higher score: small convenience sample, no delayed retention, no classroom-scale evidence, only two misconception packs.
- Confidence interval: `17–22`.
- Likely objection: “The early signal is credible, but durable and scaled impact is unproven.”
- Largest score action: report first-attempt unassisted transfer by condition with every denominator and the exact tested build.

### Quality of the Idea — 23/25

- Supporting evidence: memorable category plus demonstrated end-to-end intersection no comparator in the targeted scan visibly owns as a whole.
- Preventing a higher score: no exhaustive uniqueness claim is possible; cross-domain evidence may remain limited.
- Confidence interval: `21–24`.
...
- Unreachable, disabled, replay-only, undocumented, or unbound code receives limited credit.
- Software tests do not count as learner-impact data.
- Readiness/configuration health does not count as a completed production journey.
- “Distinctive synthesis” is supported; categorical uniqueness is not.
- The public app was available during the audit. This score does not allege an outage.

## Sources

- Official rules and project state: `evidence/test-results/devpost-official-baseline.md`, `evidence/test-results/devpost-project-baseline.md`
- Red-team challenge: `evidence/test-results/red-team.md`
