...
| Visual hierarchy breaks on small screens               | **Refined:** no required-viewport overflow, but the Judge proof begins below the first mobile fold; mode discoverability and replay density/contrast remain.                                                            |
