...
- `./scripts/verify-scientific-engines.sh --image counterlab-runner:engine-registry-v5` — passed for image `sha256:25e04f049b1dff5220f12bf63d584246d225fc31a17d0c0cad21b4388da4ec61`; authority hash `bea6f1be77f8318f4694b0e9da028440983038d34001890719dcad2d96f210b4`. The production-required variant correctly rejected the `local_candidate` snapshot.
