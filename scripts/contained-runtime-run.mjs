...
const runnerRootfsPermissionContract = Object.freeze([
  ...
  { path: "/repo", kind: "directory", mode: 0o551, gid: 10001 },
  { path: "/repo/scripts", kind: "directory", mode: 0o551, gid: 10001 },
  {
    path: "/repo/scientific-engines",
    kind: "directory",
    mode: 0o551,
    gid: 10001,
  },
  { path: "/repo/fixtures", kind: "directory", mode: 0o551, gid: 10001 },
  {
    path: "/repo/fixtures/public",
    kind: "directory",
    mode: 0o551,
    gid: 10001,
  },
  {
    path: "/repo/fixtures/notebooks",
    kind: "directory",
    mode: 0o551,
    gid: 10001,
  },
